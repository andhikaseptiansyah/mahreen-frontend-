...
const alumniStyles = `
  ...
  .alumni-section__view-all-arrow {
  ...
  .alumni-section__view-all:hover .alumni-section__view-all-arrow,
  .alumni-section__view-all:focus-visible .alumni-section__view-all-arrow {
    ...
    >
      ...
      <div className="alumni-section__inner">
        <header className="alumni-section__header">
          ...
          <a className="alumni-section__view-all" href="#/alumni">
            View All Alumni
            <span
              className="alumni-section__view-all-arrow"
              aria-hidden="true"
            >
              →
            </span>
