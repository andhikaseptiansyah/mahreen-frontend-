import iconPemberdayaan from '../../../../assets/CSR/ProgramObjective/icon-pemberdayaan-collective.svg';
import iconAksesPasar from '../../../../assets/CSR/ProgramObjective/icon-akses-pasar.svg';
