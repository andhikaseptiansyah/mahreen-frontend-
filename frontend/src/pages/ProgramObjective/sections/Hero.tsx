...
import heroBg from '../../../assets/ProgramObjective/hero-bg.png';
    ...
    <section className="po-hero">
      ...
      <div className="po-hero__container">
        ...
        <div className="po-hero__actions">
          <a href="#gabung" className="po-hero__btn po-hero__btn--primary">
            GABUNG PROGRAM
          </a>
          <a href="#kolaborasi" className="po-hero__btn po-hero__btn--outline">
            AJUKAN KOLABORASI
          </a>
        </div>
      </div>
