...
import iconStudio from "../../assets/Navbar/icon-internship.png";
  ...
  return (
    <>
      ...
      <header className={`site-header${isScrolled ? " is-scrolled" : ""}`}>
        <nav className="navbar" aria-label="Navigasi utama Mahreen Internship">
          <a
            className="navbar__brand"
            href="#/internship"
            aria-label="Kembali ke Home Mahreen Internship"
            onClick={closeMobileMenu}
          >
            <img
              className="navbar__brand-logo"
              src={iconStudio}
              alt="Mahreen Internship"
              width="290"
              height="74"
              decoding="async"
            />
            ...
            <div className="navbar__mobile-navigation">
              <a
                className={`navbar__mobile-link${
                  isActiveRoute(currentPath, "#/internship") ? " is-active" : ""
                }`}
                href="#/internship"
                aria-current={
                  isActiveRoute(currentPath, "#/internship") ? "page" : undefined
                }
                onClick={closeMobileMenu}
              >
                Home
