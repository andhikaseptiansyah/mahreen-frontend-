...
import iconCSR from "../../assets/Navbar/icon-csr.png";
  ...
  return (
    <>
      ...
      <header className={`site-header${isScrolled ? " is-scrolled" : ""}`}>
        <nav className="navbar" aria-label="Navigasi utama Mahreen CSR">
          <a
            className="navbar__brand"
            href="#/mahreen-csr"
            aria-label="Kembali ke Home Mahreen CSR"
            ...
            <div className="navbar__mobile-navigation">
              <a
                className={`navbar__mobile-link${
                  isActiveRoute(currentPath, "#/mahreen-csr") ? " is-active" : ""
                }`}
                href="#/mahreen-csr"
                aria-current={
                  isActiveRoute(currentPath, "#/mahreen-csr") ? "page" : undefined
                }
                onClick={closeMobileMenu}
              >
                Home
